...
public class EditPassword extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtUbah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/sbd/school/images/edit.png"))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/id/sbd/school/images/locked.png"))); // NOI18N
    ...
    private void txtUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUbahActionPerformed
        try {
            String sql = "SELECT password FROM pengguna WHERE username='" + user + "'";
            ...
            if (rs.next()) {
                if (!getMD5(txtPassLama.getText()).equals((rs.getString("password")))) {
                    ...
                    String sql2 = "UPDATE pengguna SET password = MD5('" + txtPassBaru.getText() + "')";
